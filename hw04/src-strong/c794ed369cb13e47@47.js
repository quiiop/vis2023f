...
function _outerCircleQuestion(){return(
"2）請問您工作地點的所在區域？"
)}
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>圖中可以發現大部分的藝術工作者集中在北部，推測是北部設計產業機會較多</li>
    <li>替代空間在南部視最大宗</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#FFD700", "#8A2BE2", "#00FF00", "#FF4500", "#87CEEB", "#9932CC", "#FF8C00"])
  .unknown("#BEBEBE")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist (1).csv", {url: new URL("./files/2dd4c491cf7e957248d1caf65a08e2bc0868d56f3569b8b379a7b67489d9faff9a54a4d2a5c4ab4642b340abb13e9abb5ca6d35acbdfcfedf3055009fdd893fc.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  ...
  main.variable(observer("outerCircleQuestion")).define("outerCircleQuestion", _outerCircleQuestion);
