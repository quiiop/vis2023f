...
FileAttachment("./files/output.json").json()
)}
...
function _simple3(d3,output,drag,invalidation)
{
  ...
  const linkForce = d3.forceLink(links)
    .id(d => d.id)
    .distance(2000) // 增加連結的距離
    .strength(2); // 可選：設定連結的強度
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["output.json", {url: new URL("./files/a34be24b36c7a17baf57b36f5f008044c1a1a2fbda93dd225e8cb0db2c996a3de5ba8749c3a62e07cbabcfa01d704c9555506e60a2bc97f4a88a680ef4964c53.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
